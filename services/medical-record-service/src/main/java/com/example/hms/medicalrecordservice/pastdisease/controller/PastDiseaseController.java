...
public class PastDiseaseController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = PastDiseaseErrorMessages.PAST_DISEASE_NOT_FOUND)
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = PastDiseaseErrorMessages.MEDICAL_HISTORY_NOT_FOUND)
    })
    @PostMapping
